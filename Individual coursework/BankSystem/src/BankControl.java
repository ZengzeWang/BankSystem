...
public class BankControl {
	...
	public Account setAcc(ArrayList<String> list) {
		int type1, fund11, fund21;
		String name1, pin1, birth1, addr1, accountnum1, date11, date21;
		Boolean state1;
		int i = 0;
	...
	/**
	 * Method wirteFile This method generate file and store all the information
	 * 
	 * @param acct
	 */
